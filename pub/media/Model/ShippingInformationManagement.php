...
class ShippingInformationManagement
{
    ...
    public function afterSaveAddressInformation(
        ...
        try {
            ...
            // Lista tuturor atributelor pe care vrem sa le salvam
            $keys = [
                'legal_cui',
                'legal_company',
                'street_number',
            ...
            if (!empty($dataToSave)) {
                ...
                if ($shippingAddress->getId()) {
                    ...
                    // Salvam o singura data, totul
                    $this->addressResource->save($shippingAddress);
                    $this->logger->info("LegalPerson: SUCCESS - Saved custom attributes.");
                }
            }
